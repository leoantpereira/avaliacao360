 ...
 * @property string $alternativaCorreta
...
class Questao extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('pergunta, alternativa01, alternativa02, resposta, questionario_id, alternativaCorreta', 'required'),
            ...
            array('alternativaCorreta', 'length', 'max' => 1),
            array('questionario_id', 'numerical', 'min' => 1, 'tooSmall' => 'Selecione um questionário.'),
            array('alternativaCorreta', 'numerical', 'min' => 1, 'tooSmall' => 'Selecione uma alternativa correta.'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, pergunta, alternativa01, alternativa02, alternativa03, alternativa04, alternativa05, alternativaCorreta, resposta, questionario_id', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
            'id' => 'Número',
            'pergunta' => 'Pergunta',
            'alternativa01' => 'Alternativa 01',
            'alternativa02' => 'Alternativa 02',
            'alternativa03' => 'Alternativa 03',
            'alternativa04' => 'Alternativa 04',
            'alternativa05' => 'Alternativa 05',
            'alternativaCorreta' => 'Alternativa Correta',
            'resposta' => 'Resposta',
            'questionario_id' => 'Questionário',
        );
    }
