...
class Departamento extends CActiveRecord {
    ...
    public static function pesqTodosNomes($idEmpresa) {
        $departamentos = Departamento::model()->findAllByAttributes(array(
            'empresa_id' => $idEmpresa,
        ));
        $nomesTodosDep = array('Selecione');

        foreach ($departamentos as $dep) {
            $nomesTodosDep[$dep->id] = $dep->nome;
        }

        return $nomesTodosDep;
    }
