...
class Avaliacao extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('idFuncAvaliado, idAvaliador, questionario_id', 'required'),
			array('idFuncAvaliado, idAvaliador, questionario_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, idFuncAvaliado, idAvaliador, questionario_id', 'safe', 'on'=>'search'),
		);
	}
